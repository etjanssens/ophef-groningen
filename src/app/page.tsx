    ...
    events: [
      {
        ...
        locations: [],
        description: "Onder begeleiding van Jan R. Lunsing fietsen maximaal tien deelnemers langs historische sporen — van één van de oprichters van de SDAP tot het PvdA Pand, waar de volgende stappen worden gezet. Start: Begraafplaats Esserveld.",
        signup: true,
      },
      {
        id: "wandeltocht-1",
        ...
        locations: [],
        description: "Wandel- en fietstocht langs grote en kleine projecten die het wonen en leven in onze gemeente mooier, leuker, veiliger, gezonder én groener hebben gemaakt. Van Dudok aan het diep tot het Zuiderplantsoen. Start: PvdA Pand (Haddingestraat 10).",
        signup: true,
      },
    ],
  },
